...
if __name__ == "__main__":
    ...
    print("="*100)
    # print(set_interface("e0", "66.45.4.11", "24"))

    # print(set_interface("e0", "66.45.5.22", "24"))

    # print(set_interface("e0", "66.45.6.33", "24"))

    print(set_interface("e0", "66.45.7.44", "24"))

    print(setup_ospf("66.0.0.0", "8", "e0"))
    # print()
    # print()
    # print()
    # print()
